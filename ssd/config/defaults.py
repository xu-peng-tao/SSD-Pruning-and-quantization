...
_C.MODEL.FINE_TUNE=False  #是否加载之前权重训练
_C.MODEL.WEIGHTS='.'
...
_C.MODEL.BACKBONE.NAME = 'cfg_backbone'
_C.MODEL.BACKBONE.OUT_CHANNELS = (512, 1024, 512, 256, 256, 256)
_C.MODEL.BACKBONE.PRETRAINED = True   #这里只是backbone权重的加载
_C.MODEL.BACKBONE.CFG='configs/vgg_bn_ssd300.cfg'
_C.MODEL.BACKBONE.WEIGHTS='pretrained/vgg_bn_ssd300_voc0712_model_final.pth'
